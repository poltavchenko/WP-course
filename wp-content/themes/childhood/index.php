            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-7 offset-1">
                  <h2
                  <?php
                  if (get_field('slider_title_color')) {
                    echo 'style="color: ' . get_field('slider_title_color') . '"';
                  }
                  ?>
                  class="slider__title"
                  >
                  ...
                  <?php
                  $field = get_field('slide_button');

                  if ($field == 'on') {
                    ?>
                    <a
                    href="<?php the_field('slide_button_link') ?>"
                    class="button"
                    >
                      Узнать больше
                    </a>
    ...
    <div class="container">
      <div class="row">
        ...
        >
          ...
          <?php endif; ?>
          <a
          href="<?php the_field('section-about_link'); ?>"
          class="button"
          >
      ...
      <div class="toys__wrapper">
        ...
        >
          <div class="toys__item-info">
            ...
            <div class="toys__item-descr">
              Хотите, чтобы ваш ребенок был под защитой даже ночью? Купите ему
              совенка!
            </div>
            <div class="minibutton toys__trigger">Подробнее</div>
          </div>
        ...
        >
          <div class="toys__item-info">
            ...
            <div class="toys__item-descr">
              Кстати, у нас большой выбор игрушек, позу которых выбирает сам
              ребенок. (Долговечные. Ноги-руки не отламываются)
            </div>
            <div class="minibutton toys__trigger">Подробнее</div>
          </div>
        </div>
        ...
        >
          <div class="toys__item-info">
            ...
            <div class="toys__item-descr">
              Ваш ребенок без ума от персонажа мультика? Мы следим за всеми
              трендами и рады предложить как самых современных, так и персонажей
              "из нашего детства"
            </div>
            <div class="minibutton toys__trigger">Подробнее</div>
          </div>
        ...
        >
          <div class="toys__item-info">
            ...
            <div class="toys__item-descr">
              Хотите, чтобы вашему ребенку все завидовали? Подарите игрушки
              нашего собственного производства! Они уникальны и ваш ребенок
              будет гордым обладателем эксклюзива!
            </div>
            <div class="minibutton toys__trigger">Подробнее</div>
          </div>
        </div>
      ...
      <div class="toys__wrapper">
        ...
        >
          <div class="toys__item-info">
            ...
            <div class="toys__item-descr">
              Кто в детстве не хотел научиться летать? А змей поможет поймать
              ветер и унести все заботы далеко-далеко...
            </div>
            <div class="minibutton toys__trigger">Подробнее</div>
          </div>
        </div>
        ...
        >
          <div class="toys__item-info">
            ...
            <div class="toys__item-descr">
              Попробуйте заинтересовать ребенка музыкой! Может в нем таится
              будущий Джаред Лето!
            </div>
            <div class="minibutton toys__trigger">Подробнее</div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-10 offset-lg-1">
          <div class="toys__alert">
            <span>Не нашли то, что искали?</span> Свяжитесь с нами - и мы с
            радостью создадим любую игрушку по вашему желанию. Вы можете выбрать
            все: размер, материал, формы...!
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="contacts__descr underlined">
            Мы находимся в Москве, метро "Парк победы", в деловом центре "Парк
            победы", второй этаж
            <br> <br>
                ...
                style="transform-origin: 50px 50px 0px; transform: scale(1);">
                  ...
                  >
                    <g>
                      ...
                      style="transform-origin: 50px 50px 0px;"
                      >
                        <d:name style="transform-origin: 50px 50px 0px;">cross
                        </d:name>
                        ...
                        <d:license style="transform-origin: 50px 50px 0px;">cc0
                        </d:license>
                        <d:slug style="transform-origin: 50px 50px 0px;">gsd528
                        </d:slug>
                      </metadata>
                    </g>
                  </g>
